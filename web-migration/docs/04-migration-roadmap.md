...
|-------|----------|--------------|--------|
| 0 | Подготовка инфраструктуры | 1-2 дня | ✅ Completed |
| 1 | Критический функционал | 3-5 дней | ✅ Completed |
...
Все API endpoints проверены и исправлены:
- Auth: `/api/auth/*`
- Users: `/api/users/me/*`
- Tenants: `/api/tenants/*`
...
- Files: `/api/files/*`
- RAG: `/api/rag/sources/*`
- MCP: `/api/mcp/*`, `/api/admin/mcp/*`
- Models: `/v1/yzma/models`
- Downloads: `/api/ui/hf/*`
