<script lang="ts">
	...
	import { faServer, faPlus, faPlay, faSquare, faArrowsRotate, faSpinner, faTrash, faGear, faWrench, faDatabase, faXmark, faMagnifyingGlass, faArrowUpRightFromSquare, faCode, faRocket, faCloud, faBrain, faBoxOpen, faChevronLeft, faChevronRight, faCopy, faCheck, faTag, faGlobe } from '@fortawesome/free-solid-svg-icons';
	...
	const isAdmin = true; // Always true in admin section
