...
func (s *SQLiteDB) CreateModelConfig(ctx context.Context, config *models.ModelConfig) error {
...
func (s *SQLiteDB) GetModelConfig(ctx context.Context, id string) (*models.ModelConfig, error) {
	query := `
...
func (s *SQLiteDB) UpdateModelConfig(ctx context.Context, config *models.ModelConfig) error {
	...
	query := `
		...
		SET model_name = ?, scope = ?, tenant_id = ?, user_id = ?, parameters = ?, updated_at = ?
		WHERE id = ?
	`
...
func (s *SQLiteDB) DeleteModelConfig(ctx context.Context, id string) error {
...
func (s *SQLiteDB) GetEffectiveModelConfig(ctx context.Context, modelName, userID, tenantID string) (*models.ModelParameters, error) {
	// Start with defaults
	effective := models.DefaultParameters()

	// Try global config
	globalConfig, err := s.GetModelConfigByScope(ctx, modelName, "global", nil)
	if err != nil {
	...
	// Try tenant config
	if tenantID != "" {
		tenantConfig, err := s.GetModelConfigByScope(ctx, modelName, "tenant", &tenantID)
		if err != nil {
	...
	if userID != "" {
		userConfig, err := s.GetModelConfigByScope(ctx, modelName, "user", &userID)
		if err != nil {
...
// Delegate methods for sqliteTx
func (tx *sqliteTx) CreateModelConfig(ctx context.Context, config *models.ModelConfig) error {
	return tx.db.CreateModelConfig(ctx, config)
}

func (tx *sqliteTx) GetModelConfig(ctx context.Context, id string) (*models.ModelConfig, error) {
	return tx.db.GetModelConfig(ctx, id)
}

func (tx *sqliteTx) GetModelConfigByScope(ctx context.Context, modelName, scope string, scopeID *string) (*models.ModelConfig, error) {
	return tx.db.GetModelConfigByScope(ctx, modelName, scope, scopeID)
}

func (tx *sqliteTx) ListModelConfigs(ctx context.Context, scope string, scopeID *string) ([]*models.ModelConfig, error) {
	return tx.db.ListModelConfigs(ctx, scope, scopeID)
}

func (tx *sqliteTx) UpdateModelConfig(ctx context.Context, config *models.ModelConfig) error {
	return tx.db.UpdateModelConfig(ctx, config)
}

func (tx *sqliteTx) DeleteModelConfig(ctx context.Context, id string) error {
