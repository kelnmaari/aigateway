  ...
  {:else if integration}
      ...
      <div class="space-y-4">
        ...
        {#if projects.length === 0}
          <div class="text-center py-12 bg-gray-800/50 rounded-xl border border-gray-700">
            <p class="text-gray-400">No projects configured yet</p>
            <p class="text-gray-500 text-sm mt-1">Add a GitLab project to start receiving AI reviews</p>
          </div>
        {:else}
    ...
    {:else if activeTab === 'settings'}
      <div class="bg-gray-800 rounded-xl border border-gray-700 p-6">
        ...
        <div class="space-y-4">
          <div>
            <label class="block text-sm font-medium text-gray-300 mb-1">API Version</label>
            <p class="text-gray-400">{integration.settings.api_version || 'v4'}</p>
          </div>
          <div>
            <label class="block text-sm font-medium text-gray-300 mb-1">Request Timeout</label>
            <p class="text-gray-400">{integration.settings.request_timeout || 30} seconds</p>
          </div>
          <div>
            <label class="block text-sm font-medium text-gray-300 mb-1">Rate Limit</label>
  ...
  <div class="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
    <div class="bg-gray-800 rounded-xl border border-gray-700 w-full max-w-lg">
      <div class="flex items-center justify-between p-6 border-b border-gray-700">
        ...
        <button on:click={() => showAddProject = false} class="text-gray-400 hover:text-gray-200">
      ...
      <form on:submit|preventDefault={handleAddProject} class="p-6 space-y-4">
        <div>
          <label class="block text-sm font-medium text-gray-300 mb-2">GitLab Project ID *</label>
          <input
            type="number"
        ...
        <div>
          <label class="block text-sm font-medium text-gray-300 mb-2">Path with Namespace</label>
          <input
            type="text"
        ...
        <div>
          <label class="block text-sm font-medium text-gray-300 mb-2">Analysis Model *</label>
          <input
            type="text"
