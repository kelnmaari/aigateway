...
CREATE TABLE IF NOT EXISTS model_providers (
    ...
    config JSONB DEFAULT '{}',               -- JSON: Provider-specific config
...
CREATE TABLE IF NOT EXISTS model_registry (
    ...
    capabilities JSONB DEFAULT '[]',        -- ["chat", "embeddings", "vision", "function-calling"]
    parameters JSONB DEFAULT '{}',          -- JSON: Model-specific parameters (max_tokens, etc)
...
-- Trigger functions для auto-update updated_at
...
CREATE TRIGGER update_model_providers_timestamp_trigger
...
CREATE TRIGGER update_model_registry_timestamp_trigger
